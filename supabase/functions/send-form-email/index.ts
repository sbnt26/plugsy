...
Plugsy Admin Dashboard - ${new Date().toLocaleString('cs-CZ')}
          ...
          html: `
            ...
            <body style="font-family: 'Poppins', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: hsl(222.2, 84%, 4.9%);">
